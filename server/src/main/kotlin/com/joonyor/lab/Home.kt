...
fun FlowContent.home() = div {
    id = "content"
    header { classes= setOf("py-5")
        div { classes = setOf("container px-5 pb-5")
            div { classes = setOf("row gx-5 align-items-center")
                div { classes = setOf("col-xxl-5")
                    div { classes = setOf("text-center", "text-xxl-start")
                        div {
                ...
                div { classes = setOf("col-xxl-7")
                    div { classes = setOf("d-flex justify-content-center mt-5 mt-xxl-0")
                        div { classes = setOf("profile bg-gradient-primary-to-secondary")
                            img { classes = setOf("profile-img")
    ...
    section {
        classes = setOf("bg-light", "py-5")
        div {
            classes = setOf("container", "px-5")
            div {
                classes = setOf("row", "gx-5", "justify-content-center")
                div {
                    classes = setOf("col-xxl-8")
                    div {
                        classes = setOf("text-center", "my-5")
                        h2 {
                            classes = setOf("display-5", "fw-bolder")
                            span {
                                classes = setOf("text-gradient", "d-inline")
                                +"About Me"
                            }
...
fun FlowContent.dots1() = div { classes = setOf("dots-1")
    svgDotsA()
}
fun FlowContent.dots2() = div { classes = setOf("dots-2")
    svgDotsB()
}
fun FlowContent.dots3() = div { classes = setOf("dots-3")
    svgDotsB()
}
fun FlowContent.dots4() = div { classes = setOf("dots-4")
    svgDotsA()
}
fun FlowContent.svgDotsA() = div {
    unsafe {
        +"""
        <!-- SVG Dots-->
